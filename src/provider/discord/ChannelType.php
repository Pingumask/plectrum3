...
{
    case GUILD_TEXT = 0;// a text channel within a server
    case DM = 1;// a direct message between users
    case GUILD_VOICE = 2;// a voice channel within a server
    ...
    case PRIVATE_THREAD = 12;// a temporary sub-channel within a GUILD_TEXT channel that is only viewable by those invited and those with the MANAGE_THREADS permission
    ...
    case GUILD_FORUM = 15;// Channel that can only contain threads
    case GUILD_MEDIA = 	16;// Channel that can only contain threads, similar to GUILD_FORUM channels
}
